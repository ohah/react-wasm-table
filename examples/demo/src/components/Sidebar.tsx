...
const sections = [
  {
    ...
    links: [
      ...
      { to: "/canvas-color", label: "Canvas: Color" },
      { to: "/canvas-tag", label: "Canvas: Tag" },
      ...
      { to: "/canvas-icon", label: "Canvas: Icon" },
      { to: "/canvas-select", label: "Canvas: Select" },
      { to: "/canvas-avatar", label: "Canvas: Avatar" },
      { to: "/canvas-datepicker", label: "Canvas: DatePicker" },
      { to: "/canvas-dropdown", label: "Canvas: Dropdown" },
