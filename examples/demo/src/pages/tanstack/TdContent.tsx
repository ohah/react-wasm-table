...
export function TanStackTdContent() {
  ...
  return (
    <>
      ...
      <Table table={tableA} width={560} height={480} theme={isDark ? DARK_THEME : LIGHT_THEME}>
        <Thead>
      ...
      <Table table={tableB} width={560} height={480} theme={isDark ? DARK_THEME : LIGHT_THEME}>
        <Thead>
