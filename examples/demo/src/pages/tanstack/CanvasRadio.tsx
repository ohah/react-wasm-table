...
export function TanStackCanvasRadio() {
  ...
  return (
    <>
      <h1>TanStack: Canvas Radio</h1>
      <p>
        <code>Radio</code> with <code>Label</code> via TanStack <code>useReactTable</code> +{" "}
        <code>Table</code> API. Self-drawing radio indicators with canvas primitives.
      </p>
